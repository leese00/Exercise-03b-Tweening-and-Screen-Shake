...
func _ready():
	...
	$Tween.interpolate_property($Hightlight, "modulate:a", $Highlight.modulate.a, modulate_target, 0.5, Tween.TRANS_LINEAR, Tween.EASE_IN_OUT)
	$Tween.start()
...
func _on_Tween_tween_all_completed():
	...
	$Tween.interpolate_property($Highlight, "modualte:a", $Highlight.modulate.a, sca, 0.5, Tween.TRANS_LINEAR, Tween.EASE_IN_OUT)
	$Tween.start()
